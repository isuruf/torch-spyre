...
from typing import TYPE_CHECKING, Callable, ClassVar, Optional, Iterable, override
...
if TYPE_CHECKING:
    _PatternTestsBase = TestCase
else:
    _PatternTestsBase = object


class PatternTests(_PatternTestsBase):
